...
<html>
<head>
<title>GearBox Contact Page</title>
<meta charset="UTF-8">
...
<!-- End Small Screen Formatting -->
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-right">
      <a href="SignIn.html" class="w3-bar-item w3-button">Sign In/Sign Up</a>
      <a href="Cart.html" class="fa fa-shopping-cart w3-margin-right"></a>
    </p>
  </header>
...
<div class="w3-padding-64 w3-light-grey w3-xlarge w3-center w3-border">
    <div class="w3-row-padding">
        <div class="w3-col s4">
            <h4>Contact Us: &nbsp &nbsp &nbsp <img src="Assets/customersupport.jpg" alt="Customer Support Icon" style="width:45%"></h4>
